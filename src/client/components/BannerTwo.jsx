    ...
    <div className="banner-item-two__slider">
        <Slider {...settings}>
            <div className="banner-item-two">
                <img
                    src="https://img.freepik.com/premium-psd/gaming-laptop-banner-template-design_1073294-46.jpg?w=1060"
                    alt=""
            ...
            <div className="banner-item-two">
                <img
                    src="https://nhatkhanhtech.com/wp-content/uploads/2019/10/Banner-gaming_laptops.jpg"  // Thay đổi đường dẫn ảnh cho slide tiếp theo
                    alt=""
