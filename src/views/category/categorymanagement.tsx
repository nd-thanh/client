...
function CategoryOverview() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // });
      const response:any = await  CategoryController.createCategory(formData);
      if (response) {
        ...
        <Box mt={5}>
          ...
          >
            <form onSubmit={handleSubmit} encType="multipart/form-data">
              ...
              <Button type="submit" colorScheme="blue"               borderRadius="md" // Hình vuông với góc bo nhẹ
 mt={4}>
                <i className="fa fa-fw fa-plus me-1"></i> Tạo Danh Mục
              </Button>
            </form>
          </Card>
        </Box>
