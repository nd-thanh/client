...
export class ProductController {
    // Fetch all products/products/admin
    ...
    static async fetchProductsAdmin(): Promise<Product[]> {
        try {
    ...
    static async createProduct(newProduct: any): Promise<any> {
        try {
            const response = await fetch(`${API_URL}creates`, {
                ...
                // },
                body: newProduct, // Convert newProduct to JSON
            });
